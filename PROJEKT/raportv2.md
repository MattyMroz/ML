...
│   └── fitzpatrick17k/
├── notebooks/
│   ├── mateusz_mroz_uci_dermatology.ipynb
│   ├── dawid_koska_dermnet.ipynb
│   └── wiktor_grzyb_fitzpatrick17k.ipynb
├── results/
│   ├── mateusz_mroz_uci_dermatology_cv_results.csv
│   ├── mateusz_mroz_uci_dermatology_final.csv
│   ├── dawid_koska_dermnet_classification_metrics.csv
│   ├── dawid_koska_dermnet_test_predictions.csv
│   └── wiktor_grzyb_fitzpatrick17k_results.csv
└── env/
    └── requirements.txt
```